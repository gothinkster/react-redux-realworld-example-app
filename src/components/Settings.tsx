...
class SettingsForm extends React.Component<any, any> {
  updateState: (field: any) => (ev: any) => void
  ...
  constructor(props?: any) {
    ...
    this.submitForm = (ev) => {
      ...
      const user: any = Object.assign({}, this.state)
      if (!user.password) {
  ...
  componentWillReceiveProps(nextProps: {
    currentUser: { image: string; username: string; bio: string; email: string }
  }) {
...
const mapStateToProps = (state: { settings: any; common: { currentUser: any } }) => ({
  ...state.settings,
  currentUser: state.common.currentUser,
})

const mapDispatchToProps = (dispatch: (arg0: { type: string; payload?: Promise<any> }) => any) => ({
